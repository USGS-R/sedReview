...
tabsetPanel(  
  ...
  navbarMenu("Data Flags and Summary",
             ...
             tabPanel(title = "Data flag summary",
                      ...
                      helpText("sedMassFlags: Tests whether a sample has a SEDIMENT MASS (p91157, NOT SSC) less than 2 mg. Flags if so. (Note: this is a new piece of metadata (pcode 91157) reported by USGS sediment laboratories so will not be available for historical data, see: ", 
