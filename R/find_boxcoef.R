...
#' Default is 30 (single vertical), 40 (multiple verticals), 50 (point sample), 55 (composite - multiple point samples), 
...
#' Default is 10 (EWI), 15 (multiple verticals non-isokinetic EWT), or 20 (EDI).
